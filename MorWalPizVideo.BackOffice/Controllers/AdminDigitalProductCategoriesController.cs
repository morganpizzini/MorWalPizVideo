...
[Authorize]
[Route("api/admin/shop/categories")]
// Explicit BackOffice admin route for digital artifact management.
public class AdminDigitalProductCategoriesController : ApplicationControllerBase
{
    private readonly IShopManagementService _shopManagementService;

    public AdminDigitalProductCategoriesController(IShopManagementService shopManagementService)
    {
