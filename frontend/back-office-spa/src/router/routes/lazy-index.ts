...
const feature = (
  path: string,
  importer: Parameters<typeof lazyRoute>[0],
  options: RouteConfig = {}
): RouteConfig => ({
  path,
  ...options,
...
const group = (
  path: string,
  actionImporter: Parameters<typeof lazyAction>[0],
...
const routeDefinitions: RouteConfig[] = [
  ...
  group('calendarevents', () => import('../../routes/calendarEvents/index'), [
    ...
    feature('create', () => import('../../routes/calendarEvents/create')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/calendarEvents/detail')),
        feature('edit', () => import('../../routes/calendarEvents/edit')),
      ],
    },
  ]),
  group('querylinks', () => import('../../routes/queryLinks/index'), [
    ...
    feature('create', () => import('../../routes/queryLinks/create')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/queryLinks/detail')),
        feature('edit', () => import('../../routes/queryLinks/edit')),
      ],
    },
  ]),
  group('quicklinks', () => import('../../routes/quickLinks/index'), [
    ...
    feature('create', () => import('../../routes/quickLinks/form')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/quickLinks/detail')),
        feature('edit', () => import('../../routes/quickLinks/form')),
      ],
    },
  ]),
  group('pages', () => import('../../routes/pages/index'), [
    ...
    feature('create', () => import('../../routes/pages/form')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/pages/detail')),
        feature('edit', () => import('../../routes/pages/form')),
      ],
    },
  ]),
  ...
  group('shortlinks', () => import('../../routes/shortLinks/index'), [
    ...
    feature('create', () => import('../../routes/shortLinks/form')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/shortLinks/detail')),
        feature('edit', () => import('../../routes/shortLinks/form')),
      ],
    },
  ]),
  group('channels', () => import('../../routes/channels/index'), [
    ...
    feature('create', () => import('../../routes/channels/form')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/channels/detail')),
        feature('edit', () => import('../../routes/channels/form')),
      ],
    },
  ]),
  ...
  ]),
  {
    ...
    children: [
      ...
      feature('translate', () => import('../../routes/videos/translate')),
      {
        ...
        Component: Outlet,
        children: [
          indexFeature('', () => import('../../routes/videos/detail')),
          feature('edit', () => import('../../routes/videos/edit')),
        ],
      },
    ],
  },
  ...
  group('morwalpizconfigurations', () => import('../../routes/morwalpizconfigurations/index'), [
    ...
    feature('create', () => import('../../routes/morwalpizconfigurations/create')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/morwalpizconfigurations/detail')),
        feature('edit', () => import('../../routes/morwalpizconfigurations/edit')),
      ],
    },
  ]),
  ...
  group('sponsors', () => import('../../routes/sponsors/index'), [
    ...
    feature('create', () => import('../../routes/sponsors/form')),
    feature(':sponsorId/edit', () => import('../../routes/sponsors/form')),
  ]),
  group('products', () => import('../../routes/products/index'), [
    ...
    feature('create', () => import('../../routes/products/form')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/products/detail')),
        feature('edit', () => import('../../routes/products/form')),
      ],
    },
  ]),
  group('compilations', () => import('../../routes/compilations/index'), [
    ...
    feature('create', () => import('../../routes/compilations/form')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/compilations/detail')),
        feature('edit', () => import('../../routes/compilations/form')),
      ],
    },
  ]),
  group('customforms', () => import('../../routes/customForms/index'), [
    ...
    feature('create', () => import('../../routes/customForms/form')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/customForms/detail')),
        feature('edit', () => import('../../routes/customForms/form')),
      ],
    },
  ]),
  group('insights', () => import('../../routes/insights/index'), [
    ...
    feature('news/:newsId', () => import('../../routes/insights/news')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/insights/detail')),
        feature('edit', () => import('../../routes/insights/form')),
        actionFeature('scan-news', () => import('../../routes/insights/scan-news/action')),
      ],
    },
  ]),
  group('keys', () => import('../../routes/apiKeys/index'), [
    ...
    feature('create', () => import('../../routes/apiKeys/form')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/apiKeys/detail')),
        feature('edit', () => import('../../routes/apiKeys/form')),
      ],
    },
  ]),
  group('ask', () => import('../../routes/ask'), [
    indexFeature('', () => import('../../routes/ask')),
    feature('create', () => import('../../routes/ask/create')),
    {
      path: ':id',
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/ask/detail')),
        feature('edit', () => import('../../routes/ask/edit')),
      ],
    },
  ]),
  group('faq', () => import('../../routes/faq'), [
    ...
    feature('candidates', () => import('../../routes/faq/candidates')),
    {
      ...
      Component: Outlet,
      children: [
        indexFeature('', () => import('../../routes/faq/detail')),
        feature('edit', () => import('../../routes/faq/form')),
      ],
    },
  ]),
];
  ...
  return {
    ...
    action:
      typeof route.action === 'function'
        ? withActionPermission(actionPermissions, route.action)
        : undefined,
    lazy: lazy
      ? async () => {
