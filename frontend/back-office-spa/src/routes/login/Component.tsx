    ...
    >
      <div className="card shadow" style={{ width: '100%', maxWidth: '400px' }}>
        <div className="card-body p-4">
          <h2 className="text-center mb-3 h3">Sign in to BackOffice</h2>
          ...
          <Form method="post">
            ...
            {isBlocked && (
              <div className="alert alert-warning" role="alert">
                ...
                <p className="mb-0">
                  Please wait {retryCountdown} second{retryCountdown !== 1 ? 's' : ''} before trying
                  again.
                </p>
              </div>
            )}
              ...
              <div className="alert alert-danger" role="alert">
                ...
                {actionData.remainingAttempts !== undefined && actionData.remainingAttempts > 0 && (
                  <small className="d-block mt-1">
                    {actionData.remainingAttempts} attempt
                    {actionData.remainingAttempts !== 1 ? 's' : ''} remaining
                  </small>
                )}
              </div>
            )}
