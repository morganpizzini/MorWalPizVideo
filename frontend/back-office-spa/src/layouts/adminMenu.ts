...
export const adminMenuGroups: AdminMenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Pages', path: '/pages', permissions: [permissions.pages.view, permissions.pages.manage], icon: FileText },
      { label: 'Navigation', path: '/navigation', permissions: [permissions.navigation.view, permissions.navigation.manage], icon: Menu },
