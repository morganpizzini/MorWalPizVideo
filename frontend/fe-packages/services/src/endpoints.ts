...
const NEWSLETTERS = `${baseEndpoint}/newsletters`;
const NEWSLETTERS_DETAIL = `${NEWSLETTERS}/{id}`;
const NEWSLETTERS_STATE = `${NEWSLETTERS_DETAIL}/state`;
const NEWSLETTERS_SEND = `${NEWSLETTERS_DETAIL}/send`;
const NEWSLETTERS_SCHEDULE = `${NEWSLETTERS_DETAIL}/schedule`;
const NEWSLETTERS_PREVIEW = `${NEWSLETTERS_DETAIL}/preview`;
const NEWSLETTERS_SUBSCRIBERS = `${NEWSLETTERS_DETAIL}/subscribers`;
